...
* remove commenting and voting on closed reviews
* change the ordering on the all reviews page to show open or closed
  * maybe separate to open, approved, and closed sections
* fix widht for the development branch text input and description text field on the review form 
* add link to diff page on review show 
* add link to reviews on project show 
* fix space on line 8 of the vote submission notificaiton
* style the homepage
* add link to github on project show page and diff page 
* add commit message above the diff (how to get all the commits for a branch)
* add submission number to emails
