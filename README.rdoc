...
* Add a redirect based on the sesion if you are forced to login before viewing a page
* Add a pending reviews section to the homepage that includes reviews you haven't voted on and reviews that are ready to be closed
* Fix line breaks in description and comments
